...
public:
    ...
    callback_t _pressed_callback = nullptr;     // Callback function for pressed events.
    callback_t _pressed_for_callback = nullptr; // Callback function for pressedFor events.
